...
export interface LengthField {
    length: Partial<EqualToField<Hybrid<number>> & MaxField & MinField & NotEqualToField<Hybrid<number>>>;
}
...
export interface NumberValueField {
    value: Partial<EqualToField<Hybrid<number>> & MaxField & MinField & NotEqualToField<Hybrid<number>>>;
}
...
export interface StringValueField {
    value: Partial<EqualToField<Hybrid<string>> & NotEqualToField<Hybrid<string>>>;
}
